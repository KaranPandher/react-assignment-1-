    ...
    return (
      ...
      <section>
        ...
        <form onSubmit={this.handleOnSubmit}>
          <label>
          <span class="error">{this.state.validationErrors.firstNameError}</span>
            <input
              type="text"
              name="firstName"
          ...
          <label>
          <span class="error">{this.state.validationErrors.feedbackError}</span>
            <input
              type="text"
              name="feedback"
          ...
          <label>
          <span class="error">{this.state.validationErrors.acceptedTermsError}</span>
            <input
              type="checkbox"
              name="acceptedTerms"
